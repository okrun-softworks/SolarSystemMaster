...
function init() {
  ...
  sunCore0.position.set(-37106, 0, 0);
  ...
  sunCore1.position.set(-37106, 0, 0);
  sunCore1.rotation.x = Math.PI * 0.002;
  scene.add(sunCore1);

  // sun
  const sunGeo = new THREE.SphereGeometry(445.65888, 30, 30, 6);
  ...
  sunHalo.position.set(-37106, 0, 0);
  ...
  sunCorona.position.set(-37106, 0, 0);
  ...
  sunCoronaEx.position.set(-37106, 0, 0);
  ...
  // mercury
  const mercuryGeo = new THREE.SphereGeometry(1.562, 30, 30, 6);
  ...
  light = new THREE.PointLight(0xfdfdfd, 0.78, 200000000000, 0, 20);
  light.position.set(-37106, 0, 0);
...
function animate() {
  ...
  mercury.rotation.y += 0.000000058646;
  mercuryObj.rotation.y += 0.00005;
